...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    ViewController *topVC = [storyboard instantiateViewControllerWithIdentifier:@"ViewController"];
    UINavigationController *navVC = [[UINavigationController alloc]initWithRootViewController:topVC];
    MenuViewController *bottomVC = [storyboard instantiateViewControllerWithIdentifier:@"MenuViewController"];
